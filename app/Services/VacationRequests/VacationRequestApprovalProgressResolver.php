...
/**
 * Exposes “faltan N” como grupos de pasos pendientes respecto a la política activa (vacaciones).
 */
final class VacationRequestApprovalProgressResolver
{
     ...
     */
    public function snapshot(VacationRequest $vacationRequest): ?array
    {
        $vacationRequest->loadMissing(['approvals', 'user']);

        if ($vacationRequest->approvals->isEmpty()) {
            return null;
        }
