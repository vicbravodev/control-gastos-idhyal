...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nuevo', href: DepartmentController.create.url() },
];

export default function AdminDepartmentsCreate() {
    ...
    function submit(e: FormEvent) {
        e.preventDefault();
        post(DepartmentController.store.url(), { preserveScroll: true });
    }
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative mx-auto flex w-full max-w-2xl animate-fade-in flex-col gap-4 p-4">
                <Heading
                    ...
                    description="Identificador estable, nombre visible y orden de aparición."
                />
                <Card>
                    <CardHeader>
