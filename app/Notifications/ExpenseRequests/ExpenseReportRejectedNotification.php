...
class ExpenseReportRejectedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('Comprobación rechazada'))
            ->line(__('Contabilidad rechazó tu comprobación. Debes corregirla y reenviarla.'))
    ...
    {
        return [
            'type' => 'expense_request.expense_report_rejected',
